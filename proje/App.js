...
const App = () => {
 ...
 submitToGoogle = async () => {  
  let body = JSON.stringify({
    requests: [
      {
        ...
        image: {
          "source":{
          "imageUri":
            "gs://proje-d72d5.appspot.com/rn_image_picker_lib_temp_a41a538b-f2bb-42fb-ad67-802fbcfde4da.jpg"
          }
        }
      }
    ]
    ...
    result = await fetch(
      "https://vision.googleapis.com/v1/images:annotate?key=AIzaSyB8mIeSaHrYKp56_VgHUSitNToltzguhOM",
       {
         headers: {
  ...
  objects=resultJson.responses[0].localizedObjectAnnotations;
 }
      ...
      <View style={styles.container}>
        ...
        {uploading ? (
          ...
          <TouchableOpacity 
           ...
           onPress={uploadImage}>
          <Text style={styles.textStyle}>Resmi Yükle</Text>
          </TouchableOpacity>
        )}
      </View>
        ...
        <TouchableOpacity
          ...
          <Text style={styles.textStyle}>Nesne Tespiti</Text>
        </TouchableOpacity>
      </View>
    </SafeAreaView>
  );
